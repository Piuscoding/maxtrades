...
const sendEmail = async ( fullname,email, available,  balance, bonus, widthdrawBalance ) =>{
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      login to see your dashboard:<br>Email:${email}<br>Available balance: ${available}<br>Deposit Balance: ${balance}<br>Bonus:${bonus}<br>Widthdrawal Balance: ${widthdrawBalance}<br>You can login here: https://lyron-trades.com/login<br>.<br>Thank you.</p>`
  }
